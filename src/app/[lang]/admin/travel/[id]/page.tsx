        ...
        <div className="flex items-center gap-3">
          <VerifyOfficeButton
            ...
            labels={{
              ...
              unverify: a.unverifyOffice ?? "Remove verification",
              verifying: a.verifying ?? "Working...",
              verifiedToast: a.officeVerifiedToast ?? "Office verified — now visible in public search",
              unverifiedToast: a.officeUnverifiedToast ?? "Verification removed — hidden from public search",
