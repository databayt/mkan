...
// pre-rendered QR data-URL arrive from the server page; this file owns only
// the print interaction and print-scoped styles.
...
export function TicketContent({ booking, qrCodeUrl, lang }: TicketContentProps) {
