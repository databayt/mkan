...
const DescriptionPageContent = ({ params }: DescriptionPageProps) => {
  ...
  const highlights = [
    {
      id: "1",
      title: dict.hosting.pages.description.peaceful,
      iconSrc: cdn.vendor("airbnb", "highlights/peaceful.svg"),
    },
    {
      id: "2",
      title: dict.hosting.pages.description.unique,
      iconSrc: cdn.vendor("airbnb", "highlights/unique.svg"),
    },
    {
      id: "3",
      title: dict.hosting.pages.description.familyFriendly,
      iconSrc: cdn.vendor("airbnb", "highlights/family-friendly.svg"),
    },
    {
      id: "4",
      title: dict.hosting.pages.description.stylish,
      iconSrc: cdn.vendor("airbnb", "highlights/stylish.svg"),
    },
    {
      id: "5",
      title: dict.hosting.pages.description.central,
      iconSrc: cdn.vendor("airbnb", "highlights/central.svg"),
    },
    {
      id: "6",
      title: dict.hosting.pages.description.spacious,
      iconSrc: cdn.vendor("airbnb", "highlights/spacious.svg"),
    },
  ];
