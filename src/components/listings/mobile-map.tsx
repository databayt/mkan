    ...
    <div className="md:hidden px-4 py-6">
      ...
      <div className="relative w-full h-[250px] mb-4 rounded-lg overflow-hidden border border-[#e5e7eb]">
        ...
        <div className="absolute bottom-3 right-3 flex gap-1">
          <Button size="icon" variant="outline" className="w-6 h-6 rounded-full bg-[#ffffff] border-[#e5e7eb] hover:bg-[#e5e7eb]" aria-label="Zoom in">
            <Plus className="w-2.5 h-2.5 text-[#374151]" />
          </Button>
          <Button size="icon" variant="outline" className="w-6 h-6 rounded-full bg-[#ffffff] border-[#e5e7eb] hover:bg-[#e5e7eb]" aria-label="Zoom out">
