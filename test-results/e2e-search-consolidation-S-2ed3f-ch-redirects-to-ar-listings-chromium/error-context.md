...
- Name: e2e/search-consolidation.spec.ts >> Search route consolidation (Epic 3.4) >> /ar/search redirects to /ar/listings
- Location: tests/e2e/search-consolidation.spec.ts:16:7
