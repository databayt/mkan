...
- Name: e2e/search-consolidation.spec.ts >> Search route consolidation (Epic 3.4) >> redirects preserve query params
- Location: tests/e2e/search-consolidation.spec.ts:28:7
